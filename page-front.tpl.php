...
<div id="header-top"><!--header-top-->
	...
	<div id="block-fb_social_like-like" class="clear-block block block-fb_social_like">
           <div class="content">
              <div style="margin-left: -20px;" class="fb-social-like-widget">
              <fb:like  href="http://www.facebook.com/Plexydesk" send="false" layout="button_count" action="like" font="verdana" colorscheme="dark"></fb:like>              </div>
           </div> 
            </div>
